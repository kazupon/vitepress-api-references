...
- Check if the issue is reproducible with the latest stable version of `vitepress-api-references`. If you are using a pre-release, please indicate the specific version you are using.
