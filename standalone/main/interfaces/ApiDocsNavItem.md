...
- `children` _(optional)_ `property` [`ApiDocsNavItem`](/standalone/main/interfaces/ApiDocsNavItem.md)\[\] - Nested navigation items for grouped modules or declaration hierarchies.
