...
- `collapsed` _(optional)_ `property` `boolean` | ((`item`: [`ApiDocsNavItem`](/standalone/default/interfaces/ApiDocsNavItem.md), `depth`: `number`) =\> `boolean` | `undefined`) - Collapsed state for generated sidebar branches, or a resolver called per item. **Default:** `undefined`
